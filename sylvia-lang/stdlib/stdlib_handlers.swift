...
func call_exponent_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_positive_a(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_negative_a(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_subtract_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_multiply_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_divide_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_div_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_mod_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isLessThan_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isLessThanOrEqualTo_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isEqualTo_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isNotEqualTo_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isGreaterThan_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_isGreaterThanOrEqualTo_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_NOT_a(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_AND_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_OR_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_XOR_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_lt_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_le_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_eq_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_ne_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_gt_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_ge_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_joinValues_a_b(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_uppercase_a(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_lowercase_a(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_show_value(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_formatCode_value(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
let interface_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv = CallableInterface(
    ...
    parameters: [
        ...
        ("returnType", signature_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv.paramType_2),
        ("action", signature_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv.paramType_3),
        ("isEventHandler", signature_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv.paramType_4),
    ],
    returnType: signature_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv.returnType
)
func call_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_store_name_value_readOnly_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_testIf_condition_action_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_repeatTimes_count_action_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
...
func call_repeatWhile_condition_action_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, coercion: Coercion) throws -> Value {
