...
func call_defineHandler_name_parameters_returnType_action_isEventHandler_commandEnv(command: Command, commandEnv: Env, handler: CallableValue, handlerEnv: Env, type: Coercion) throws -> Value {
